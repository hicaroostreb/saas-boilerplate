...
test.describe('Authentication Flow Tests', () => {
  ...
  test('complete user registration and organization setup flow', async ({
    page,
  }) => {
  ...
  test('should handle invalid credentials properly', async ({ page }) => {
    ...
    const hasError = await page
      .locator('text=/invalid|incorrect|error|wrong/i')
      .isVisible();
  ...
  test('should validate required fields', async ({ page }) => {
    ...
    const hasValidationError =
      (await page
        .locator('text=/required|fill|enter|provide/i')
        .first()
        .isVisible()) ||
  ...
  test('should handle loading states', async ({ page }) => {
    ...
    const submitButtonDisabled = await page
      .locator('button[type="submit"]:disabled')
      .isVisible();
    const loadingText = await page
      .locator('text=/signing in|loading|submitting/i')
      .isVisible();
