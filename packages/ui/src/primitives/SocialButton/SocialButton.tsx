...
/**
 * SocialButton component - Social authentication buttons
 *
 * @example
 * ```
 * function SocialAuth() {
...
export function SocialButton({
  ...
  return (
    <Button
      variant={variant === 'filled' ? 'primary' : variant}
...
function getSocialConfig(provider: SocialButtonProps['provider']) {
  const configs = {
    google: {
