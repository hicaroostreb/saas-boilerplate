...
const navigationItems = [
  {
    ...
    icon: (
      <svg
        ...
        className="lucide lucide-house size-4 shrink-0"
      >
  ...
  },
  {
    ...
    icon: (
      <svg
        ...
        strokeLinecap="round"
        strokeLinejoin="round"
        className="lucide lucide-settings size-4 shrink-0"
      >
...
export function DashboardSidebar({
  ...
  return (
    ...
    >
      ...
      <div
        className={`duration-200 relative h-svh bg-transparent transition-[width] ease-linear ${collapsed ? 'w-[--sidebar-width-icon]' : 'w-[--sidebar-width]'}`}
      />

      {/* ✅ ENTERPRISE: Fixed sidebar */}
      <div
        className={`duration-200 fixed inset-y-0 z-40 hidden h-svh transition-[left,right,width] ease-linear md:flex left-0 border-r ${collapsed ? 'w-[--sidebar-width-icon]' : 'w-[--sidebar-width]'}`}
      >
        <div
        ...
        >
          ...
          <div
            data-sidebar="header"
            className="gap-2 p-3 flex h-14 flex-row items-center py-0"
          >
            <ul
              data-sidebar="menu"
                                ...
                                >
                                  ...
                                  >
                                    ...
                                    <span className="relative flex overflow-hidden size-4 flex-none shrink-0 rounded-md">
                                      ...
                                      />
                                      <span className="hidden size-4 items-center justify-center rounded-md border border-neutral-200 bg-neutral-100 text-xs font-medium text-neutral-500 dark:border-neutral-700 dark:bg-neutral-900">
