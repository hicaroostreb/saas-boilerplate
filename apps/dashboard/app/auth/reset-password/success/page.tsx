          ...
          <div className="rounded-xl border bg-card text-card-foreground shadow w-full px-4 py-2 border-transparent dark:border-border">
            <div className="flex flex-col space-y-1.5 p-6">
              ...
              <div className="text-center space-y-2">
                ...
                <div className="space-y-1">
                  ...
                  {email && (
                    <p className="text-sm text-muted-foreground">
                      You can now sign in to <span className="font-medium text-foreground">{email}</span>
                    </p>
                  )}

                  {organizationSlug && (
                    <p className="text-sm text-muted-foreground">
                      Organization: <span className="font-medium text-foreground">{organizationSlug}</span>
                    </p>
                  )}
                </div>
              </div>
            ...
            <div className="items-center p-6 pt-0 flex flex-col space-y-3 text-sm">
              <Link 
                ...
                href={organizationSlug ? `/auth/sign-in?org=${organizationSlug}` : "/auth/sign-in"}
              >
                Sign In Now
              </Link>
